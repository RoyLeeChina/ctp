 ...
 * @version 1.0.2
 */
public class OldWeChat {
    private static Logger logger = LoggerFactory.getLogger(OldWeChat.class);
    ...
    public void startListner() {
        ...
        qrCodeThread.setListener(new OnloadQrCodeFinnishListener() {
            ...
            public void onLoadSuccess(byte[] imageBytes) {
                ...
                WaitScanAndLoginThread loginThread = new WaitScanAndLoginThread(uuid, OldWeChat.this);
    ...
    class InitThread extends Thread {
        ...
        public void run() {
            ...
            if (!isBeat) {
                ...
                syncKeys(initResult);
                //开启心跳线程
                HeartBeatThread heartBeatThread = new HeartBeatThread(OldWeChat.this);
