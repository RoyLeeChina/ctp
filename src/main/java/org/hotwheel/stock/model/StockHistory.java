...
public class StockHistory {
     ...
     */
    public StockHistory(Date day, double open, double high, double low, double close, double volume, double MA5, double MA5Volume) {
     ...
     */
    public StockHistory(Date day, double open, double high, double low, double close, double volume, double MA5, double MA5Volume, double MA10, double MA10Volume) {
     ...
     */
    public StockHistory(Date day, double open, double high, double low, double close, double volume, double MA5, double MA5Volume, double MA10, double MA10Volume, double MA30, double MA30Volume) {
