...
public class HistoryDataPOJO {
	 ...
	 */
	public HistoryDataPOJO(Date day,double open,double high ,double low ,double close,double volume){
		super();
		this.day = day;
		this.open = open;
		this.high = high;
	 ...
	 */
	public HistoryDataPOJO(Date day,double open,double high ,double low ,double close,double volume,double MA5,double MA5Volume){
	 ...
	 */
	public HistoryDataPOJO(Date day,double open,double high ,double low ,double close,double volume,double MA5,double MA5Volume,double MA10,double MA10Volume){
	 ...
	 */
	public HistoryDataPOJO(Date day,double open,double high ,double low ,double close,double volume,double MA5,double MA5Volume,double MA10,double MA10Volume,double MA30,double MA30Volume){
